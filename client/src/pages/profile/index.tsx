...
export default function ProfilePage() {
  ...
  const handleFile = async (file: File) => {
    try {
      if (!file.type.startsWith("image/")) {
        toast({
          title: "Invalid file",
          description: "Choisis une image فقط / خاصك تختار صورة فقط.",
          variant: "destructive",
        });
        return;
      }
      ...
      if (file.size > 5 * 1024 * 1024) {
        toast({
          ...
          description: "Maximum 5MB / الحد الأقصى 5MB.",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        title: "Image loaded",
        description: "Clique sur Save Profile pour enregistrer définitivement.",
      });
    } catch (error) {
      toast({
        title: "Upload failed",
        description: "Impossible de lire l'image / تعذر قراءة الصورة.",
        variant: "destructive",
      });
    }
  };
    ...
    updateProfile.mutate(
      ...
      },
      {
        onSuccess: () => {
          ...
          toast({
            title: "Profile saved",
            description: "Le profil a été enregistré dans la base de données.",
          });
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Password UI only",
      description:
        "Password backend is not connected yet. نقدر نربطو من بعد إلا بغيتي.",
    });
            ...
            <div className="px-6 pb-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Drag & drop or click — JPG, PNG, WEBP up to 5MB
                    </p>
                  </div>
                  <Button
                    type="button"
              ...
              <div className="mb-5">
                ...
                <p className="text-[11px] text-slate-400 mt-1.5 font-medium">
                  Avatar saved in database after clicking Save Profile.
                </p>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              {pwdForm.new && (
                <div className="space-y-1 mt-2">
                  ...
                  <p
                    className={`text-[11px] font-bold ${pwdStrength <= 2
                        ? "text-rose-500"
                        : pwdStrength <= 3
                          ? "text-amber-500"
                          : "text-emerald-600"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`rounded-xl bg-slate-50 border-slate-200 text-sm pr-9 ${pwdForm.confirm && pwdForm.new !== pwdForm.confirm
                      ? "border-rose-300"
                      : ""
                    }`}
